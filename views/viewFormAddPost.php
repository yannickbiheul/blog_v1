...
<div class="container">
    ...
    ?>
    <br>
    <form action="index.php?action=pullPost" method="POST">
        ...
        <div class="mb-3">
            <label for="formFile" class="form-label" name="image">Image</label>
            <input class="form-control" type="file" id="formFile">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label" name="content">Contenu</label>
